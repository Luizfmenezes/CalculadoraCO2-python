...
def checkcmbo():
     ...
     if cmb.get() == "Gasolina":
         ...
         messagebox.showinfo(title=(f'RESULTADO DA EMISSÃO'), message=f'Foram emitidos em {KM} KM aproximadamente {co2e} KG de CO2')
         messagebox.showinfo(title=("Compensação"), message=f'Seria Necessário o plantio de {compensação_arvores} árvores para compensar o CO2 emitido no prazo de 1 ano' )
